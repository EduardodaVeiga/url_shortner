...
export default function App() {
    ...
    const copyLink = async () => {
        try {
            ...
            } absolute  place-self-center z-10 rounded-md drop-shadow-[0px_0px_10px_rgb(0,0,0,0.2)] bg-slate-50 mt-[400px]`}
                >
            ...
            setTimeout(() => {
                setCopyModal(
                    <div className={`${"animated__animated  animate__bounceOut"} absolute  place-self-center z-10 rounded-md drop-shadow-[0px_0px_10px_rgb(0,0,0,0.2)] bg-slate-50 mt-[400px]`}>
                        <div className="flex items-center justify-center px-10 py-5">
                            <h1 className="text-blue-500 text-xl font-medium">Link copied to clipboard!</h1>
                        </div>
                    </div>
    ...
    return (
        <div className=" flex items-center justify-center w-screen h-screen bg-slate-50 relative">
            {copyModal}
            <svg onClick={copyLink} className={` flex cursor-pointer absolute top-10 bg-slate-400 rounded-md p-1 fill-white w-10`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <div className="relative w-2/3 flex h-fit flex-col items-center gap-4">
                    ...
                    {loading ? (
                        ...
                        <div className="w-full items-center relative flex gap-2 ">
                            <a className={`bottom-[-100px] w-full break-words text-center text-blue-500 text-xl `} href="/">
                                {response}
                            </a>
                            <svg
                                onClick={copyLink}
